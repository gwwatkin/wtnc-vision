/**
 * card-badges.test.js — Component tests for provenance badges on Card (FR-parity).
 *
...
import { Card } from '../components/results/Card.js';
...
/**
 * Build a minimal Result-shaped crossing object.
...
/**
 * Mount Card with given crossing and return the container element.
 * @param {object} crossing
 * @returns {Element}
 */
function mountCard(crossing) {
...
/**
 * Unmount and remove a container produced by mountCard.
