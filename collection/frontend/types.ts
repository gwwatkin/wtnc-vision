/**
 * types.ts — Single frozen type surface for the FE Modernization spec.
 *
 * Declares all data shapes (FROZEN-1), state/action shapes (FROZEN-4),
 * and component prop types (FROZEN-5). Import via:
 *   import type { XxxProps } from '../../types';   // components
 *   import type { State, Action } from './types';  // root-level modules
 *
